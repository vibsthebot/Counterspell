...
spritePic = pygame.transform.scale(pygame.image.load("images/spritepicFINAL.png").convert_alpha(), (40, 70))
spriteRunning = pygame.transform.scale(pygame.image.load("images/spriterunning.png").convert_alpha(), (40, 70))
